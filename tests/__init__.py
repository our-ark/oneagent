...
never read or modify a developer's live `.oneagent` daemon state.
"""
...
STATE_HOME = Path(tempfile.mkdtemp(prefix="oneagent-test-state-"))

os.environ["ONEAGENT_STATE_REDIRECT_ROOT"] = str(SOURCE_ROOT)
os.environ["ONEAGENT_STATE_HOME"] = str(STATE_HOME)
