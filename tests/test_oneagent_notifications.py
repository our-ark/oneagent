...
from oneagent.app.inbox import inbox_path
...
class OneAgentNotificationTests(unittest.TestCase):
    ...
    def test_intent_persistence_failure_happens_before_provider_call(self) -> None:
        with TemporaryDirectory() as directory:
            ...
            with patch(
                "oneagent.app.notifications.persist_notification_intent",
    ...
    def test_crash_after_provider_success_reconciles_without_second_send(self) -> None:
        with TemporaryDirectory() as directory:
            ...
            with patch(
                "oneagent.app.notifications.complete_notification",
    ...
    def test_inbox_replay_after_local_crash_does_not_repeat_reply(self) -> None:
        ...
        with TemporaryDirectory() as directory:
            ...
            with (
                ...
                patch(
                    "oneagent.app.core.mark_reply_sent",
