...
from oneagent.evolution.core import EvolveCandidate
...
class OneAgentEvolveEventTests(unittest.TestCase):
    ...
    def test_schema_six_promotion_replays_into_semantic_review_fields(self) -> None:
                ...
                json.dumps(
                    {
                        ...
                        "pr_url": "https://github.com/our-ark/oneagent/pull/12",
        ...
        self.assertEqual(event.review_id, "https://github.com/our-ark/oneagent/pull/12")
