...
from oneagent.profiles import registry as profile_registry
...
from oneagent.private_state import UnsupportedPrivateStateError
...
class OneAgentProfileTests(unittest.TestCase):
    ...
    def test_application_rejects_unsupported_private_state(self, validate) -> None:
        with TemporaryDirectory() as temp:
            ...
            self.assertFalse((root / ".oneagent" / "daemon_epoch.json").exists())
