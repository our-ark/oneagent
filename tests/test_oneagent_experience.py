...
from oneagent.evolution.sources.experience import experience_path, load_experience_records, record_task_experience
from oneagent.evolution.evidence import (
    pending_evidence_counts,
    save_evidence_batch_size,
    scan_evidence,
)
from oneagent.tasks.events import TASK_EVENT_TYPES, TASK_SOURCES, load_task_events, task_event_path
...
class OneAgentExperienceTests(unittest.TestCase):
    ...
    def test_records_structured_terminal_task_experience(self) -> None:
            ...
            job = _task_job(
                ...
                result="\n".join(
                    [
                        ...
                        "Files:",
                        "- src/oneagent/telegram/bot.py",
                    ]
                ),
                pr_urls=("https://github.com/our-ark/oneagent/pull/42",),
            )
        ...
        self.assertEqual(record.changed_files, ("src/oneagent/telegram/bot.py",))
        self.assertEqual(record.pr_urls, ("https://github.com/our-ark/oneagent/pull/42",))
