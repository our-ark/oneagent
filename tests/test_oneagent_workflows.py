...
from oneagent.profiles import AgentProfile, CommandSpec
from oneagent.providers import ChatEvent, RuntimeResult
...
class WorkflowEngineTests(unittest.TestCase):
    ...
    def test_application_accepts_injected_runtime_and_workflow(self) -> None:
        ...
        with TemporaryDirectory() as directory:
            ...
            core_queue_absent = not (root / ".oneagent" / "task_queue.json").exists()
