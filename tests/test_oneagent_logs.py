...
from oneagent.logs import conversation_log_path, log_conversation_turn, log_system_event, system_log_path
...
class OneAgentLogsTests(unittest.TestCase):
    ...
    def test_log_paths_can_be_computed_for_specific_days(self) -> None:
        ...
        self.assertEqual(
            ...
            oneagent_home(ROOT) / "artifacts" / "logs" / "system" / "2026-06-19.jsonl",
        )
