...
Worker state is local runtime state under `.oneagent/`:

- `.oneagent/task_queue.json`
- `.oneagent/backlog.json`
- `.oneagent/cron.json`
...
8. Keep the agent-instance branch as the resident control worktree. Give every
   ...
   tests, commits, publication, and review handoff there. Keep `.oneagent` queue,
