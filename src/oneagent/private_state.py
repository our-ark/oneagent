...
from oneagent.config import _parse_simple_yaml
from oneagent.paths import private_state_path, storage_layout
from oneagent.state import (
...
def _normalized_payload(path: Path, schema: StateFileSchema) -> dict[str, Any]:
    ...
    if schema.pattern == "self.json":
        from oneagent.agent_identity import validate_agent_identity
...
def _normalize_backlog(path: Path, data: dict[str, Any]) -> dict[str, Any]:
    from oneagent.backlog import _item_to_dict, _parse_item
...
def _normalize_cron(path: Path, data: dict[str, Any]) -> dict[str, Any]:
    from oneagent.cron import _job_to_dict, _parse_job
...
def _normalize_extension_schedules(
    ...
    from oneagent.extensions.schedules import _parse_status, _status_to_dict
...
def _normalize_evolve_candidates(
    ...
    from oneagent.evolution.core import _candidate_from_json, _candidate_to_json
