...
try:
    ...
    from oneagent.providers._capability_compat import (
        CAPABILITY_CONTRACT_VERSION,
        AuthorizationDecision,
        AuthorizationPolicy,
        AuthorizationRequest,
...
try:
    ...
    from oneagent.providers._runtime_result_compat import (
        AgentRuntimeTimedOut,
        RUNTIME_CONTRACT_VERSION,
        RUNTIME_EXECUTION_CONTRACT_VERSION,
        RuntimeEvent,
...
try:
    ...
    from oneagent.providers._notification_compat import (
        DurableNotificationProvider,
        NOTIFICATION_CONTRACT_VERSION,
        NotificationCapabilities,
        NotificationDeliveryError,
