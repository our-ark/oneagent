...
from oneagent.app.activity import record_direct_action
...
from oneagent.app.models import ForgeMaintenanceRequest, WorkOutcome, WorkStatusMessage
from oneagent.app.parsing import (
    existing_branch_publish_request,
    forge_maintenance_request,
)
from oneagent.app.presentation import clip_activity_text
...
from oneagent.providers.forge import feature_title
from oneagent.providers.authorization import CapabilityAuthorizationError
from oneagent.providers.runtime import invoke_runtime_action
from oneagent.runtime import (
...
from oneagent.workflows import WorkflowEngine
...
def work_reply_failed(reply: str) -> bool:
    ...
    return (
        normalized.startswith("oneagent could not ")
