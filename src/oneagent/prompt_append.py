...
EDIT_REQUEST_START = "[ONEAGENT_EDIT_REQUEST]"
EDIT_REQUEST_END = "[/ONEAGENT_EDIT_REQUEST]"
MEMORY_REQUEST_START = "[ONEAGENT_MEMORY_REQUEST]"
MEMORY_REQUEST_END = "[/ONEAGENT_MEMORY_REQUEST]"
TASK_REGRESSION_START = "[ONEAGENT_TASK_REGRESSION]"
TASK_REGRESSION_END = "[/ONEAGENT_TASK_REGRESSION]"
