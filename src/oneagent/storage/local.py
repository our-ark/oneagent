...
def _private_state_root(body: Path) -> Path:
    redirected_root = os.environ.get("ONEAGENT_STATE_REDIRECT_ROOT", "").strip()
    redirected_home = os.environ.get("ONEAGENT_STATE_HOME", "").strip()
