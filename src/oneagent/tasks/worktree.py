...
def task_worktree_path(control_root: Path, task_id: int) -> Path:
    ...
    return resolved.parent / ".oneagent-task-worktrees" / f"{resolved.name}-{instance_key}" / f"task-{task_id}"
